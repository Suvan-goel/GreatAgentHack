...
groupsync/
  backend/
    ...
    state.py                # In-memory project_state and helpers
    utils/
      pdf_utils.py          # PDF -> text
      date_utils.py         # Date parsing, ID helpers
      scheduler.py          # Simple non-LLM scheduler
    agents/
      scope_agent.py
      role_matching_agent.py
      plan_agent.py
      checkin_agent.py
      tension_radar_agent.py
      supervisor_agent.py
      orchestration.py      # run_weekly_analysis, etc.
  frontend/
    index.html
    src/
      main.tsx
      ...
      pages/
        ...
        CheckInPage.tsx
        TensionDashboardPage.tsx
      components/
        TaskList.tsx
        WeeklyPlanTable.tsx
        MemberRiskCard.tsx
        RiskSummaryBanner.tsx
  README.md
